...
class MultiDimensinalGRUCell(tf.keras.layers.Layer):
    """
    Detailled computations are from https://arxiv.org/pdf/1604.04378.pdf
    """
    def __init__(self,
                 units,
                 activation=None,
                 kernel_initializer='glorot_uniform',  # from normal GRU
                 recurrent_initializer='orthogonal',  # from normal GRU
                 bias_initializer='zeros',  # from normal GRU
